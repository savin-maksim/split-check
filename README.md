...
[Split Check](https://splitcheck-adaa6.web.app/) - веб-приложение для разделения совместного чека между участниками. Приложение помогает завести несколько чеков, добавить людей и позиции расходов, указать кто платил и на кого делится каждая позиция, а затем рассчитать итоговые переводы.
