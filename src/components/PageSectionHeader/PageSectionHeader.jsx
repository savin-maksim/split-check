  ...
  return (
    <header className={rootClass}>
      <div className="page-section-header__title-block">
        {icon != null && <span className="page-section-header__icon-wrap">{icon}</span>}
        <div className="page-section-header__text">
          <TitleTag className="page-section-header__title">{title}</TitleTag>
          {showSubtitle && <p className="page-section-header__subtitle">{subtitle}</p>}
        </div>
      </div>
      {action != null && <div className="page-section-header__actions">{action}</div>}
    </header>
  )
}
