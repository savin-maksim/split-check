    ...
    <div className="people-section">
      <div className="people-section__container">
        ...
        {people.length === 0 ? (
          <div className="people-section__empty">
            ...
            <p>
              Нажмите на кнопку в навигационной панели, чтобы добавить людей,
              между которыми нужно разделить расходы
            </p>
            <Arrow />
          </div>
        ) : (
      ...
      >
        ...
        <p className="people-section__modal-text">
          Будут удалены все участники и все расходы. Это действие нельзя
          отменить.
        </p>
        <div className="modal__buttons">
          <ActionButton onClick={() => setIsClearAllModalOpen(false)}>
            Отмена
          </ActionButton>
          <ActionButton
            onClick={confirmRemoveAll}
            className="people-section__modal-btn-danger"
          >
            Удалить всех
          </ActionButton>
        </div>
