...
import { IconButton, EIconButtonVariant } from '@/shared/ui'
import { cn, formatItemTitle, formatMoneyRaw, createKeyboardActivationHandler } from '@/shared/lib'
...
const ReceiptPreviewItemComponent = ({
  ...
  >
    ...
    <div className="receipt-preview-item__footer">
      ...
      <span className="receipt-preview-item__total">{formatMoneyRaw(item.price * qty)}</span>
    </div>
  </div>
  )
}
